...
int main(void)
{
    ...
    for (i = 0; i < FFT_N; i++)
    {
        ...
        tempf1[3] = 0.2 * cosf((40 * 2 * PI * i / FFT_N) + PI / 6) * 256;
        data_hard[i].real = (int16_t)(tempf1[0] + tempf1[1] + tempf1[2] + tempf1[3] + 10);
    ...
    printf("Data format conversion for hard fft module.\n");
